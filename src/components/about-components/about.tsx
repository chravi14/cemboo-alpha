...
export const AboutContainer = () => {
  return (
    <>
      ...
      <InnerContainer>
        <Styled.AboutStatsWrapper>
          <Styled.StatsItemWrapper>
            <Styled.StatsYear>2011</Styled.StatsYear>
            <Styled.StatsYearSubText>year founded</Styled.StatsYearSubText>
          </Styled.StatsItemWrapper>
          <Styled.StatsItemWrapper>
            <Styled.StatsYear>55</Styled.StatsYear>
            <Styled.StatsYearSubText>Employees</Styled.StatsYearSubText>
          </Styled.StatsItemWrapper>
          <Styled.StatsItemWrapper>
            <Styled.StatsYear>5M+</Styled.StatsYear>
            <Styled.StatsYearSubText>Developers</Styled.StatsYearSubText>
          </Styled.StatsItemWrapper>
          <Styled.StatsItemWrapper>
            <Styled.StatsYear>20,123</Styled.StatsYear>
            <Styled.StatsYearSubText>Customers</Styled.StatsYearSubText>
          </Styled.StatsItemWrapper>
        </Styled.AboutStatsWrapper>
      </InnerContainer>
      <InnerContainer>
        <Styled.StoryWrapper>
          <Styled.StoryTitle>Our Story</Styled.StoryTitle>
          <Styled.StoryTextWrapper>
            <Styled.StoryText>
              ...
              Haydenfilms itself is dedicated to the support and development of
              emerging independent filmmakers and student filmmakers.
            </Styled.StoryText>
            <Styled.StoryText>
              The organization’s founder, Hayden Craddolph, envisioned the Film
              Festival out of his thesis during his time as an Electronic Media
              postgraduate at Kutztown University in 2001. In 2004, Haydenfilms
              hosted what would be one of the world’s first online film
              festivals.
            </Styled.StoryText>
            <Styled.StoryText>
            ...
            <Styled.StoryText>
              ...
              ability to distribute, share, own, and showcase their own digital
              content, as well as content created by others. By 2011,
